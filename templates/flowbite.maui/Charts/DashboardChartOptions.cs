...
namespace Flowbite.Maui.Charts;
...
public static class DashboardChartOptions
{
    ...
    where TItem : class
  {
    ...
    return new ApexChartOptions<TItem>
    {
      ...
      Markers = new Markers
      {
        Size = new ApexCharts.Size(6),
        StrokeColors = isDarkMode ? "#111827" : "#ffffff",
        StrokeWidth = new ApexCharts.Size(2),
    ...
    where TItem : class
  {
    ...
    return new ApexChartOptions<TItem>
    {
      ...
      {
        Show = true,
        Width = new ApexCharts.Size(5),
        Colors = new List<string> { "transparent" }
      },
      Grid = new ApexCharts.Grid { Show = false },
