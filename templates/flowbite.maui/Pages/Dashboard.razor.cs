...
public partial class Dashboard : IDisposable
{
    ...
    private bool _isReady; // Delay rendering until WebView is ready
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        if (firstRender)
        {
            // Add delay to ensure WebView is fully initialized (MAUI Blazor Hybrid)
